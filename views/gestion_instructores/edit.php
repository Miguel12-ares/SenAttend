...
$title = 'Editar Instructor - SENAttend';
$showHeader = true;
...
<div class="container">
    <div class="page-header">
        <div>
            <h1><i class="fas fa-pen-to-square"></i> Editar Instructor</h1>
            <p>Modifique la información del instructor</p>
        </div>
    ...
    <div class="form-container">
        <form method="POST" action="/gestion-instructores/<?= $instructor['id'] ?>" id="instructorForm">
            <div class="form-card">
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        inputmode="numeric"
                        pattern="[0-9]{7,15}"
                        value="<?= htmlspecialchars($_SESSION['old']['documento'] ?? $instructor['documento']) ?>"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        minlength="2"
                        maxlength="100"
                        value="<?= htmlspecialchars($_SESSION['old']['nombre'] ?? $instructor['nombre']) ?>"
                        required
                    >
                ...
                <div class="form-group">
                    ...
                    <input 
                        ...
                        value="<?= htmlspecialchars($_SESSION['old']['email'] ?? $instructor['email']) ?>"
                        required
                    >
