...
/**
 * Vista: Crear Portero
 * Formulario para crear un nuevo portero
 */

$title = 'Crear Portero - SENAttend';
$showHeader = true;
...
<div class="container">
    <div class="page-header">
        <div>
            <h1><i class="fas fa-user-plus"></i> Crear Nuevo Portero</h1>
            <p>Complete el formulario para registrar un nuevo portero</p>
        </div>
    ...
    <div class="form-container">
        <form method="POST" action="/gestion-porteros" id="porteroForm">
            <div class="form-card">
                ...
                <div class="alert alert-info">
                    ...
                    El portero deberá cambiarla en su primer inicio de sesión.
                </div>
            </div>

            <div class="form-actions">
                <a href="/gestion-porteros" class="btn btn-secondary"><i class="fas fa-times"></i> Cancelar</a>
                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Guardar Portero</button>
            </div>
        </form>
    </div>
</div>
